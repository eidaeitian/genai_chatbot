...
class IntentAgent(BaseAgent):
    ...
    def analyze_intent_fn(self, query: str) -> str:
        ...
        #     print(parsed)
        #     self.intent_analysis = parsed 
        #     return self.intent_analysis
        # except json.JSONDecodeError as e:
        #     print("❌ JSON decoding failed:", e)
        #     print("🪵 Raw string was:", repr(response.content))
        #     return {
    ...
    def run(self, query: str) -> Dict[str, Any]:
        ...
        # try:
        #     return json.loads(result)  # ✅ Safely parse it into dict
        # except json.JSONDecodeError:
        #     print("❌ Could not parse final agent output")
        #     return {}
