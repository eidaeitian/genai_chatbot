...
def return_instructions_root() -> str:
    ...
    <TASK>
        ...
        #     * **SQL Query:** "The complete SQL query that was executed"
        ...
        * **When users ask questions about BigQuery data, ALWAYS return both the SQL query and the results in your output. Include the SQL query used and the corresponding results in your response.**
        * **ALWAYS include the SQL query in your response when call_db_agent is used. Extract the SQL from the agent's response and display it clearly.**
    </TASK>
    ...
    - a Python data science agent (`call_ds_agent`), if necessary.
