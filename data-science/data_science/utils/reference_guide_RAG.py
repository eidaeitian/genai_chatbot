...
display_name = "enterprise_metrics_guides_corpus"

paths = [
    # Enterprise Metrics User Guides - correct view mode URL
    "https://docs.google.com/document/d/15sUnNCKm9XR5nqI49EoOb8rT9rd-tYhVe-EtR_hHnIw/view?tab=t.f8urfdl3vb7x#heading=h.15yygzd5hnf5",
    # Alternative: If you get GCS permissions later
    # "gs://dig-coe-genai-0548-rag-storage/Enterprise Metrics User Guides.docx"
